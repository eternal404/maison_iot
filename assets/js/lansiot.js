...
$(document).ready(function() {
    ...
    $('.input-number').change(function() {
        ...
        $.get("ajax.php", {
            action: "changer_mode_chaudiere",
            mode: "auto",
            temperature_cible: $("#temperature_cible").val()
        })
            .fail(function() {
        ...
        .done(function(reponse) {
            ...
            Morris.Line({
                ...
                data: [
                    ...
                    {
                        y: reponse.historique.salon[1].timestamp,
                        salon: reponse.historique.salon[1].temperature
                    },

                    {
                        y: reponse.historique.salon[2].timestamp,
                        salon: reponse.historique.salon[0].temperature
                    }, {
                        y: reponse.historique.salon[3].timestamp,
                        salon: reponse.historique.salon[1].temperature
                    },

                    {
                        y: reponse.historique.salon[4].timestamp,
                        salon: reponse.historique.salon[0].temperature
                    }, {
                        y: reponse.historique.salon[5].timestamp,
                        salon: reponse.historique.salon[1].temperature
                    },
                    //
